    ...
    return (
      <section className="w-full bg-[#eeeeee] text-black px-4 md:px-16 lg:px-[200px] py-8">
        ...
        <ul className="flex justify-center gap-8 text-sm md:text-lg font-normal">
          <li><ScrollLink to="#" smooth={true} duration={500} className="hover:underline cursor-pointer">ACCUEIL</ScrollLink></li>
          <li><ScrollLink to="#" smooth={true} duration={500} className="hover:underline cursor-pointer">HISTOIRES</ScrollLink></li>
          <li><ScrollLink to="#" smooth={true} duration={500} className="hover:underline cursor-pointer">VR</ScrollLink></li>
          <li><ScrollLink to="#" smooth={true} duration={500} className="hover:underline cursor-pointer">SAVOIR PLUS</ScrollLink></li>
        </ul>
